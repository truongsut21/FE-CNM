...
export const TaskComponent = ({ task }) => {
    ...
    return (
        <>
            ...
            <div className={"card w-full p-3 bg-base-100 shadow-xl mt-2 ring-1"}>
                <div>
                    <div className="inline-block float-right"><div className="flex items-center">
                    ...
                    <p className="text-xs">{task.tentrangthai} - <strong className="text-rose-500">Còn {deadline} ngày</strong></p>
                </div>
