            ...
            <>
              <TitleCard key={k} title={i.name} topMargin={"mt-2"}>
                <div className="">
                  ...
                  <div className="mt-6 text-right absolute bottom-5 right-5">
                    <button className="mx-1 border-none btn bg-emerald-300 hover:bg-emerald-200 btn-sm">
                      Tạo nhắc nhở
                    </button>
                    <button className="mx-1 border-none btn bg-teal-300 hover:bg-teal-200 btn-sm">
                      Báo cáo
                    </button>
                    <button className="mx-1 border-none btn bg-cyan-400 hover:bg-cyan-300 btn-sm">
                      Xem chi tiết
                    </button>
                  </div>
                </div>
