...
import InfoRoomRightDrawer from "../features/chat/components/drawChat/InfoRoomRightDrawer";
...
function RightSidebar() {
  ...
  return (
    ...
    >
      <section
        className={
          "w-1/4  right-0 absolute bg-base-100 h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform  " +
