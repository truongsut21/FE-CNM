...
const routes = [
...

  {
    ...
    submenu: [
      ...
      },
      {
        ...
        icon: <UserIcon className={submenuIconClasses} />, // icon component
        name: "Nhật Nam", // name that appear in Sidebar
      },
      {
        path: "/app/chat/1114", //url
        icon: <UserIcon className={submenuIconClasses} />, // icon component
        name: "Bò Con", // name that appear in Sidebar
      },
      {
        path: "/app/chat/22241", //url
        icon: <UserIcon className={submenuIconClasses} />, // icon component
        name: "Ỉa Chảy", // name that appear in Sidebar
      },
    ],
  },

  {
    ...
    name: "Nhóm", // name that appear in Sidebar
    submenu: [
      {
